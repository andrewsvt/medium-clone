...
function HMenu() {
  ...
  return (
    <header
      className={`py-5 text-sm border-b-[1px] fixed top-0 w-[100%] transition ease-in-out duration-200 ${
        navBarShow ? `bg-white` : `bg-yellow`
      } z-10`}
    >
      <div className="flex flex-row justify-between items-center max-w-7xl mx-auto">
        ...
        <div className="items-center space-x-[25px]">
          <div className="hidden items-center space-x-[25px] md:inline-flex">
          ...
          <button className="text-[#fff] bg-black px-4 py-2 rounded-full cursor-pointer">
            Get Started
          </button>
        </div>
      </div>
